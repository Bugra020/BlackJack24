...
public class Dealer {
	...
	public JLabel getNewCard() {
		...
		this.cardLabels.get(this.cardLabels.size() - 1).setLocation(522 - (60 * (this.cards.size() - 1)), 10);
